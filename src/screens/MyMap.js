...
import { placesSelector } from '../store/selectors/places';

const { height, width } = Dimensions.get('window');
const ASPECT_RATIO = width / height;
const LATITUDE = -29.4296301390512;
const LONGITUDE = -66.86876641586423;
...
class MyMap extends Component {
  ...
  myMarkers = () => {
    ...
    return current_places.length ? (
      current_places.map((place) => (
        <Marker
